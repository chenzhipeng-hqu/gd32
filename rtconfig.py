...
if  CROSS_TOOL == 'gcc':
    ...
    EXEC_PATH   = r'/opt/st/stm32cubeide_1.1.0/plugins/com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.7-2018-q2-update.linux64_1.0.0.201904181610/tools/bin'
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -Wl,--gc-sections,-Map=./build/rtthread-gd32.map,-cref,-u,Reset_Handler -T ./drivers/gd32_rom.ld'
    ...
    POST_ACTION += '@' + OBJCPY + ' -O ihex $TARGET ./build/rtthread.hex\n'
